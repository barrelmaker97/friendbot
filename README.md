...
### /action
This endpoint accepts HTTP `POST` requests in the form of `application/x-www-form-urlencoded`, extracts a JSON payload, and interprets corresponding interaction with the given Friendbot messages. These include sending the generated sentence to the channel, shuffling to generate a new sentence, and cancelling the sentence generation.
