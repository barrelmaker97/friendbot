...
### /action
This endpoint accepts HTTP `POST` requests in the form of `application/x-www-form-urlencoded`, extracts a JSON payload, and provides the interactive component of Friendbot messages. These interactions include sending a generated sentence to the channel, shuffling to generate a new sentence, and cancelling sentence generation.
